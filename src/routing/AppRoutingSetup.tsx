...
import { AllRecordingsPage, RecordPage } from '@/pages/recordings';
import {
  ProfileActivityPage,
  ProfileBloggerPage,
  CampaignsCardPage,
...
import { GlasProLayout } from '@/layouts/glaspro';
  ...
  return (
    <Routes>
      <Route element={<RequireAuth />}>
        <Route element={<GlasProLayout />}>
          <Route path="/" element={<DefaultPage />} />
          <Route path="/recordings" element={<AllRecordingsPage />} />
          <Route path="/recordings/:id" element={<RecordPage />} />
