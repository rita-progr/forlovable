...
const Login = () => {
  ...
  // Получаем сообщение и email из state, если они есть
  ...
  const formik = useFormik({
    initialValues: {
      ...initialValues,
      // Если есть email из регистрации, используем его
      email: registrationEmail || initialValues.email
    },
  ...
  return (
    <div className="card max-w-[390px] w-full">
      ...
      >
        ...
        {registrationMessage && (
          <Alert variant="success">{registrationMessage}</Alert>
        )}
